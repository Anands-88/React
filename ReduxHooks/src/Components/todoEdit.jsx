...
import { AddTodoTask, GetTodos } from "../Redux/Todos/action";
import { useDispatch } from "react-redux";
import { useParams,useNavigate } from "react-router-dom";
import axios from "axios";
import { FirstSide,SecondSide,CheckBox,CreateInput,SubButton } from "./styled";
...
export const TodoEdit = () =>
{
   ...
   const {personal,official,others} = tags
    ...
    useEffect(()=>{
        axios.get(`http://localhost:8884/todos/${id}`).then(({data})=>{
    ...
    <div style={{width:"80%",display:"flex"}}>
        ...
        <SubButton onClick={()=>{editTask()}}>Add task</SubButton>
    </div>
</div>
}